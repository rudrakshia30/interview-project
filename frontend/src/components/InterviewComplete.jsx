    ...
    return (
        <main className="page-container">
            <section className="completion-panel">
                ...
                <p className="completion-description">Download your original videos before refreshing or closing this browser tab.</p>
                        ...
                        return (
                            <article className="completed-answer-card" key={questionIndex}>
                                ...
                                {recording ? (
                                    ...
                                    <p className="missing-recording">This recording is unavailable. It may have been removed by refreshing the page.</p>
                                )}
                            </article>
                        );
                    })}
                </div>
                <button type="button" className="primary-button" onClick={onRestart}>Start New Interview</button>
            </section>
        </main>
    );
}
